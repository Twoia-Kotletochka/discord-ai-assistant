...
- предупреждения о лимитах отправляются только при падении ещё на 15 пунктов: по умолчанию 35%, 20%, 5%; меняется через `API_LIMIT_ALERT_START_PERCENT` и `API_LIMIT_ALERT_STEP_PERCENT`.
