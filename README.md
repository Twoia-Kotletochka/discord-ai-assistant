...
Плеер использует свой поток через `yt-dlp` и `ffmpeg`, а не команды других Discord-ботов. Пока играет музыка, голосовой TTS-ответ ассистента не перебивает трек: ответ уходит текстом в Discord.
