...
$('#featuresForm').addEventListener('submit', async (event) => {
  ...
  const data = {
    ...
    telegramInboundEnabled: form.elements.telegramInboundEnabled.checked,
    telegramInboundAllowedChatIds: form.elements.telegramInboundAllowedChatIds.value,
    telegramInboundPlainForward: form.elements.telegramInboundPlainForward.checked,
